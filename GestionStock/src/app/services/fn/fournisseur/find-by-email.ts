...
export function findByEmail(http: HttpClient, rootUrl: string, params: FindByEmail$Params, context?: HttpContext): Observable<StrictHttpResponse<FournisseurResponse>> {
...
findByEmail.PATH = '/fournisseurs/email/{email}';
