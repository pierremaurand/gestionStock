...
export function findById2(http: HttpClient, rootUrl: string, params: FindById2$Params, context?: HttpContext): Observable<StrictHttpResponse<FournisseurResponse>> {
...
findById2.PATH = '/fournisseurs/id/{id}';
