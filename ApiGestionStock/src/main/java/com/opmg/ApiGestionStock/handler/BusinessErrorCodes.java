...
public enum BusinessErrorCodes {
    ...
    CODE_COMMANDE_CLIENT_ALREADY_EXISTS(6002, HttpStatus.BAD_REQUEST, "Code commande client already exists"),

    COMMANDE_FOURNISSEUR_NOT_FOUND(7000, HttpStatus.NOT_FOUND, "Commande fournisseur not found"),
    COMMANDE_FOURNISSEUR_NOT_VALID(7001, HttpStatus.BAD_REQUEST, "Commande fournisseur not valid"),
    CODE_COMMANDE_FOURNISSEUR_ALREADY_EXISTS(7002, HttpStatus.BAD_REQUEST, "Code commande fournisseur already exists"),
